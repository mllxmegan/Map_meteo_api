...
L.marker([43.185447298142975, 3.040350603646218], {icon: mcdonaldIcon}).addTo(map).bindPopup("<img src='assets/img/map/mcdo.jpeg' width='100%'/><strong>Mc Donalds</strong><br/>Burgers d'anthologies. Ce restaurant vous offrira une gastronomie d'exception.");
L.marker([43.173767, 2.993], {icon: bowlingIcon}).addTo(map).bindPopup("<img src='assets/img/map/bowling.jpg' width='100%'><br/><strong>L'Espace Liberté-Bowling</strong><br/>Le bowling est un endroit agréable à venir entre amis, même en étant trés nul vous pouvez vous réfugier dans le pub et vous alcooliser pour avoir un meilleur niveau.");
